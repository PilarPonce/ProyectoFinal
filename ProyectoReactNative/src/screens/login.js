    ...
    render(){
        ...
        return(
            ...
            <View style={styles.formContainer}>
                ...
                <TouchableOpacity onPress={() => this.props.drawerProps.navigation.navigate('Register')} style={styles.redireccion}><Text >Don´t have an account? Tap here to sign up </Text> </TouchableOpacity>
